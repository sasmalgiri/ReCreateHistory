    ...
    <div className="border-t border-ink-800 px-3 py-2">
      <div className="flex items-center justify-between gap-2">
        <div className="min-w-0">
          <div className="truncate text-xs text-ink-300">{user?.displayName || user?.email || 'Account'}</div>
          <div className="text-[10px] text-ink-600">private workspace</div>
        </div>
        <button className="shrink-0 rounded-md p-1.5 text-ink-500 hover:bg-ink-800 hover:text-rose-300" title="Log out" onClick={() => logout()}>
